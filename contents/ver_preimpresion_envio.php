...
<head>
    <meta charset="utf-8"/>
    <title>Vista Previa - Ticket de Recepcion - Sebeal Transporte - desarrollado por Luna Systems Peru</title>
...
<div class="wrapper">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Envios de Mercaderia</li>
                        </ol>
                    </div>
        ...
        <!-- end page title -->
        <div class="row">
            <h1 class="page-title col-md-12" style="text-align: center; margin-bottom: 25px;">Vista Preliminar Ticket</h1>
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <a href="ver_envios.php" class="btn btn-success"><i class="fa fa-arrow-left"></i> Ver Envios</a>
