...
$idPrestamo=filter_input(INPUT_GET, 'prestamo');
...
$prestamoPago->setIdPrestamo($idPrestamo);

$listaPagos=$prestamoPago->verFilas();
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <div class="">
                        <button onclick=" eliminarContrato(<?php echo $prestamo->getIdPrestamo()?>)"
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <label for="" class="font-weight-bold">Codigo Prestamo:</label>
                            <label for=""><?php echo $prestamo->getIdPrestamo()?></label>
                            ...
                            <br>
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Cnt. Cuotas:</label>
                                <label for=""><?php echo $prestamo->getTotCuotas()?></label>
                            </div>
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Fecha Inicio:</label>
                                <label for=""><?php echo $prestamo->getFecha()?></label>
                            </div>
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Fecha de pago:</label>
                                <label for=""><?php echo $prestamo->getFechaPago()?></label>
                            </div>
                            <br>
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Total a Pagar:</label>
                                <label for=""><?php echo $prestamo->getMonto()?></label>
                            </div>
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Total Pagado:</label>
                                <label for=""><?php echo $prestamo->getTotalPagado()?></label>
                            </div>
                            <div class="form-group">
                                <label for="" class="font-weight-bold">Faltante:</label>
                                <label for=""><?php echo $prestamo->getMonto()-$prestamo->getTotalPagado() ?></label>
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <span data-toggle="modal" data-target="#modal_pago_contrato" class="btn btn-success"><i class="fa fa-plus"></i>Agregar</span>
                            ...
                            <table class="table table-striped">
                                ...
                                foreach ($listaPagos as $fila) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $fila['nro_cuota']?></td>
                                        <td class="text-center">
                                            <button onclick="eliminarPago(<?php echo $idPrestamo .",".$fila["id_movimiento"]?>)" class="btn btn-icons btn-danger" title="Eliminar Pago"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    <?php
                                }
...
<div class="modal fade" id="modal_pago_contrato" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-4"
     style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="formulario_modal_pago" action="../controller/reg_pago_prestamo.php" method="POST">
                ...
                <div class="modal-body">
                    <input id="id_contrato" type="hidden" name="id_prestamo" value="<?php echo $prestamo->getIdPrestamo()?>">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="monto_total" value="<?php echo $prestamo->getMonto()?>" class="form-control" id="monto_total" readonly>
                    </div>
                    <div class="form-group">
                        <label for="monto" class="col-form-label">Monto Pagado:</label>
                        <input type="text" name="monto_pagado" value="<?php echo $prestamo->getTotalPagado()?>" class="form-control" id="monto_pagado" readonly>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formulario_modal_mod_pago"  method="post">
                    ...
                    <input type="hidden" name="idContrato" value="<?php echo $idPrestamo ?>">
                    <div class="form-group">
                        <label for="monto" class="col-form-label">Monto:</label>
                        <input value="<?php echo $prestamo->getMonto()?>" required type="number" name="monto" class="form-control" id="montoUDt">
                    </div>
                    <div class="form-group">
                        <label for="fecha" class="col-form-label">Fecha:</label>
                        <input type="date" value="<?php echo date("Y-m-d"); ?>" name="fecha" class="form-control"
                    ...
                    <div class="form-group">
                        <label for="fecha" class="col-form-label">Cuotas:</label>
                        <input type="number" value="<?php echo $prestamo->getTotCuotas()?>"  name="duracion" class="form-control"
                        >
                    </div>
                </form>
            </div>
    ...
    function eliminarPago(idP,idM) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "../controller/del_pago_prestamo.php",
                    data: {id_movimiento: idM,id_prestamo:idP},
                    success: function (data) {
                        console.log(data);
                        if (IsJsonString(data)){
                           location.reload();
